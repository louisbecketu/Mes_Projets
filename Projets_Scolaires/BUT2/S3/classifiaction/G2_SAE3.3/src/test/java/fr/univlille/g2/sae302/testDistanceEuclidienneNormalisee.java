...
import fr.univlille.g2.sae302.model.DistanceEuclidienneNormalisee;
...
public class testDistanceEuclidienneNormalisee {
    @Test
    public void test_distance_euclidienne_normalisee() throws IOException {
        ...
        double distance = new DistanceEuclidienneNormalisee(data, data, List.of("sepal.length", "sepal.width", "petal.length", "petal.width")).getDistance();
        assertEquals(0.0, distance, 0.0);
        assertEquals(0.1767766952966369, new DistanceEuclidienneNormalisee(data2, data, List.of("sepal.length", "sepal.width", "petal.length", "petal.width")).getDistance(), 0.0);
    }
}
